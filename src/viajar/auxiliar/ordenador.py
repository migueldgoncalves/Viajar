...
CSV_DESTINO = 'destino.csv'
CSV_LIGACAO = 'ligacao.csv'
CSV_LOCAL = 'local.csv'
CSV_LOCAL_ESPANHA = 'local_espanha.csv'
CSV_LOCAL_GIBRALTAR = 'local_gibraltar.csv'
CSV_LOCAL_PORTUGAL = 'local_portugal.csv'
...
def obter_ponto_cardeal_oposto(ponto_cardeal):
    if ponto_cardeal == NORTE:
        return SUL
    elif ponto_cardeal == NORDESTE:
        return SUDOESTE
    elif ponto_cardeal == ESTE:
        return OESTE
    elif ponto_cardeal == SUDESTE:
        return NOROESTE
    elif ponto_cardeal == SUL:
        return NORTE
    elif ponto_cardeal == SUDOESTE:
        return NORDESTE
    elif ponto_cardeal == OESTE:
        return ESTE
    elif ponto_cardeal == NOROESTE:
        return SUDESTE
    else:
        return ''
