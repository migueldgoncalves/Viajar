...
MUNICIPIO_GELVES = "Gelves"  # Sevilha
...
concelhos_faro = [CONCELHO_ALCOUTIM, CONCELHO_ALBUFEIRA, CONCELHO_CASTRO_MARIM, CONCELHO_FARO, CONCELHO_LOULE,
                  CONCELHO_OLHAO, CONCELHO_SAO_BRAS_ALPORTEL, CONCELHO_TAVIRA, CONCELHO_VRSA]

#  Concelhos das entidades intermunicipais e regiões
algarve = [CONCELHO_ALCOUTIM, CONCELHO_ALBUFEIRA, CONCELHO_CASTRO_MARIM, CONCELHO_FARO, CONCELHO_LOULE, CONCELHO_OLHAO,
...
FREGUESIA_BOLIQUEIME = "Boliqueime"  # Loulé
...
FREGUESIA_LUZ_TAVIRA = "Luz de Tavira"  # Tavira
...
FREGUESIA_OLHOS_DE_AGUA = "Olhos de Água"  # Albufeira
FREGUESIA_PECHAO = "Pechão"  # Olhão
FREGUESIA_PEREIRO = "Pereiro"  # Alcoutim
FREGUESIA_QUARTEIRA = "Quarteira"  # Loulé
FREGUESIA_QUELFES = "Quelfes"  # Olhão
FREGUESIA_QUERENCA = "Querença"  # Loulé
