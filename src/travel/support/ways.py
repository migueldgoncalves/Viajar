...
ES_A31 = Way("A-31", "Autovía de Alicante", SPAIN, ROAD)
...
ES_GC1 = Way("GC-1", "Autopista del Sur de Gran Canaria", CANARY_ISLANDS, ROAD)
ES_GC21 = Way("GC-21", "Carretera General Miraflor", CANARY_ISLANDS, ROAD)
...
PT_EN11A = Way("EN 1-1A", "2ª Circular", PORTUGAL, ROAD)  # Freeway in São Miguel Island, Azores
...
PT_VR1 = Way("VR 1", "Via Rápida 1", PORTUGAL, ROAD)  # Freeway in Madeira Island
...
ES_SFM_T3 = Way("SFM T3", "SFM T3: Palma - Manacor", SPAIN, RAILWAY)
ES_TENERIFE_TRAMWAY_T1 = Way("Tenerife Tramway - Line 1", "Tranvia Línea 1: La Trinidad - Intercambiador", CANARY_ISLANDS, RAILWAY)
...
PT_PORTO_METRO_LINE_A = Way("Porto Metro - Line A", "Linha A: Senhor de Matosinhos ⇒ Estádio do Dragão", PORTUGAL, RAILWAY)
PT_PORTO_METRO_LINE_B = Way("Porto Metro - Line B", "Linha B: Póvoa de Varzim ⇒ Estádio do Dragão", PORTUGAL, RAILWAY)
PT_PORTO_METRO_LINE_C = Way("Porto Metro - Line C", "Linha C: ISMAI ⇒ Campanhã", PORTUGAL, RAILWAY)
PT_PORTO_METRO_LINE_D = Way("Porto Metro - Line D", "Linha D: Hospital de São João ⇒ Santo Ovídio", PORTUGAL, RAILWAY)
PT_PORTO_METRO_LINE_E = Way("Porto Metro - Line E", "Linha E: Trindade ⇒ Aeroporto", PORTUGAL, RAILWAY)
PT_PORTO_METRO_LINE_F = Way("Porto Metro - Line F", "Linha F: Senhora da Hora ⇒ Fânzeres", PORTUGAL, RAILWAY)
