...
class CalculadoraDistancias:
    ...
    def gerar_mapa_processado(self, lista_coordenadas: list[Coordenada], via_tipo: str, pais: str,
    ...
    def calcular_distancia(self, origem: Coordenada, destino: Coordenada, verboso: bool = True) -> float:
        """
    ...
    def _coordenadas_para_no(self, coordenadas: Coordenada):
        """
