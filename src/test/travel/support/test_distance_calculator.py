...
class TestDistanceCalculator(unittest.TestCase):
    ...
    def test_generate_processed_map_check_large_area_warning(self):
        ...
        self.assertEqual(2, stdout_redirect.getvalue().count(expected_output))  # One appearance per routine call with large area
    ...
    def test_calculate_distance_with_adjusts_successful_ceuta(self):
        ...
        bottom_left_map_corner = Coordinates(35.88385, -5.33438)
        upper_right_map_corner = Coordinates(35.89308, -5.29278)
    ...
    def test_calculate_distance_with_adjusts_successful_melilla(self):
        ...
        # Urban route - Entire territory
        bottom_left_map_corner = Coordinates(35.270494, -2.955701)
        upper_right_map_corner = Coordinates(35.296265, -2.941824)
        source = Coordinates(35.270414, -2.942804)
        destination = Coordinates(35.294973, -2.953157)
        self.dist_calc.generate_processed_map([bottom_left_map_corner, upper_right_map_corner], ways.ROAD, ways.SPAIN, osm_interface.DETAIL_LEVEL_URBAN, None)
        self.assertEqual(3.2, self.dist_calc.calculate_distance_with_adjusts(source, destination, less_checks=True))  # In Google Maps, 3.3 km
        # Testing with less_checks=False takes too long - Skipping
