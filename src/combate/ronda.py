from combate import combatente, aleatorio
...
class Ronda:
    ...
    def ataque(atacante, defensor, parte_corpo):
        pontos_ataque_base = atacante.get_forca() * atacante.get_arma() * aleatorio.Aleatorio.dois_dados()
        ...
        pontos_defesa_base = defensor.get_velocidade() * defensor.get_arma() * aleatorio.Aleatorio.dois_dados()
    ...
    def ronda_loop(self):
        ...
        self.jogador = combatente.Combatente("Jogador1", 0, 0, 3, True, False)
        self.inimigo = combatente.Combatente("Inimigo", 0, 0, 3, False, True)
        ...
        while True:
            ...
            if self.inimigo.get_saude_geral() <= 0:
                ...
                exit()
            self.ataque(self.inimigo, self.jogador, aleatorio.Aleatorio.numero_aleatorio(7))
